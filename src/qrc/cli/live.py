...
from qrc.audio.mic_source import iter_mic_chunks
...
def run_live() -> None:
    ...
    console.print("[bold]Listening... (Ctrl-C to stop)[/bold]")
    try:
        for samples, sr in iter_mic_chunks(sample_rate=settings.sample_rate):
